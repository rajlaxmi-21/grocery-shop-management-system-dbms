...
def login_view(request):
    ...
    if request.method == 'POST':
        ...
        connection = sql.connect(host="localhost", user="root", passwd="raju", database="shop")
...
def admin_action(request):
    if request.method == "POST":
        m = sql.connect(host="localhost", user="root", passwd="raju", database="shop")
        cursor = m.cursor()
...
def place_order(request):
    ...
    if request.method == 'POST':
        # Connect to the database
        conn = sql.connect(user='root', password='raju',
